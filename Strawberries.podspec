...
Pod::Spec.new do |s|
    s.name             = 'Strawberries'
    s.version          = '1.1.1'
    s.summary          = 'Strawberries from PlayCover'
    s.swift_versions   = '5'
  ...
  TODO: Add long description of the pod here.
    ...
    s.source           = { :git => 'https://github.com/PlayCover/Strawberries.git', :tag => s.version.to_s }
    # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'
  
    s.platforms = { :ios => "14.0" }
    s.source_files = 'Strawberries/**/*'
  
    # s.resource_bundles = {
    #   'GoChannel' => ['GoChannel/Assets/*.png']
    # }
    s.ios.framework  = 'UIKit', 'IOKit'
    s.exclude_files = "Strawberries/Info.plist"
    s.public_header_files = 'Strawberries/Strawberries.h.h'
